...
const FilterPersonalityShow = ({ filterPersonality }) => {
  return (
        ...
        renderItem={({ item, index }) => {
          return (
            <TouchableOpacity
              ...
              onPress={() => filterPersonality(item, index)}
            >
              <Text style={styles.buttonLabel}>{item.personality}</Text>
            </TouchableOpacity>
          );
        }}
      />
...
export default FilterPersonalityShow;
